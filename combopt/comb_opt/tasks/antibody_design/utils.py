...
def download_precomputed_antigen_structure(AbsolutNoLib_dir: str, antigen: str, num_cpus: Optional[int] = 1,
    ...
    if num_cpus > 0:
        ...
        absolut_run_command = ["./../../AbsolutNoLib", 'repertoire', antigen, f"TempCDR3_{antigen}.txt"]
    ...
    if repertoire_output.stdout.split('\n')[4] == \
            'ERR: the list of binding structures for this antigen could not been found in this folder...':
        download_command = subprocess.run(["./../../AbsolutNoLib", 'info_fileNames', f'{antigen}'], capture_output=True,
                                          text=True)
