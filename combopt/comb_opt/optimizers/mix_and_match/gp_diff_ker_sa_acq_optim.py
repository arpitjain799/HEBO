...
class GpDiffusionSaAcqOptim(BoBase):
    ...
    def name(self) -> str:
        if self.use_tr:
            name = f'GP (Diffusion) - Tr-based SA acq optim'
        else:
            name = f'GP (Diffusion) - SA acq optim'
        return name
    ...
    def __init__(self,
        ...
        super(GpDiffusionSaAcqOptim, self).__init__(search_space, n_init, model, acq_func, acq_optim, tr_manager, dtype,
                                                    device)
