...
def get_task_sp(mixed: bool) -> (TaskBase, SearchSpace):
...
def test_sa(mixed: bool, use_tr: bool):
    task, search_space = get_task_sp(mixed=mixed)
    ...
    optimizer = SimulatedAnnealing(search_space, fixed_tr_manager=tr_manager, allow_repeating_suggestions=False)
